 ...
 */
class modmultidevise extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		//	                       );
		$this->module_parts = array('hooks'=>array('thirdpartycard','propalcard', 'ordercard', 'invoicecard','paiementcard','ordersuppliercard'),'triggers'=>1);
		...
		$this->config_page_url = array("index.php@multidevise");
	...
	{
		return $this->_load_tables('/multidevise/sql/');
	}
}
