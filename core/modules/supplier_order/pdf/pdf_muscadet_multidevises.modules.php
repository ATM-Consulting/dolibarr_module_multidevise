 ...
 */
class pdf_muscadet_multidevises extends ModelePDFSuppliersOrders
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db,$object)
	{
		...
		$this->db = $db;
		$this->name = "muscadet_multidevises";
	...
	function _pagefoot(&$pdf, $object, $outputlangs, $hidefreetext=0)
	{
		...
		$res = pdf_pagefoot($pdf,$outputlangs,'SUPPLIER_ORDER_FREE_TEXT',$this->emetteur,$this->marge_basse,$this->marge_gauche,$this->page_hauteur,$object,0,$hidefreetext);
